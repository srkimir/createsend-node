module.exports=function Transactional(createsend) {
    ...
    function txResponseCallback(error, response, body, callback) {
        if (error) {
            callback(error);
        } else {
    ...
    function smartEmailList(details, callback) {
        ...
        createsend.get('transactional/smartemail', details, null, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }

    //  Get the details for a smart transactional email
    function smartEmailDetails(details, callback) {
        createsend.get('transactional/smartemail/'+details.smartEmailID, null, null, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
    ...
    function sendSmartEmail(details, callback) {
        createsend.post('transactional/smartemail/'+details.smartEmailID+'/send', null, details, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
    ...
    function sendClassicEmail(details, callback) {
        deleteNullProperties(details);
        createsend.post('transactional/classicEmail/send', details.clientID, details, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
    ...
    function classicEmailGroupList(details, callback) {
        createsend.get('transactional/classicEmail/groups', details, null, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
    ...
    function statistics(details, callback) {
        deleteNullProperties(details);
        createsend.get('transactional/statistics', details, null, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
    ...
    function messageTimeline(details, callback) {
        deleteNullProperties(details);
        createsend.get('transactional/messages', details, null, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
    ...
    function messageDetails(details, callback) {
        createsend.get('transactional/messages/'+details.messageID, details, null, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
    ...
    function messageResend(details, callback) {
        createsend.post('transactional/messages/'+details.messageID+'/resend', null, null, function(error, response, body) {
            txResponseCallback(error, response, body, callback);
        }, true);
    }
